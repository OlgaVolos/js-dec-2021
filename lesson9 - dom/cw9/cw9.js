...
//
//     member.appendChild(divName);
//     member.appendChild(divSurname);
//     member.appendChild(divAge);
//     member.appendChild(divInfo);
...
for (const course of coursesArray) {
    ...
    for (const ulElement of course.modules) { // ітеруємо поле модуля!!!!!
